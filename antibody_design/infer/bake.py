...
class A4Generator_BeamSearch(nn.Cell):
    """WithLossCell"""
    def __init__(self, config, prompt_model=None, with_posterior=True, freeze_prior=True):
    ...
    def sample(self, log_probs, state_log_probs,
        ...
        log_probs = ops.Squeeze(2)(log_probs)
        ...
        cumsum_scores = mnp.cumsum(new_topk_scores, axis=-1) # (bs*beam, vocab_size)
